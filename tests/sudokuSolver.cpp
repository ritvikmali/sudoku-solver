...
#define N 9
using namespace std;
int grid[N][N] = {{6, 0, 5, 0, 0, 8, 0, 1, 9}, {0, 9, 0, 6, 1, 7, 4, 3, 5}, {0, 4, 0, 0, 0, 9, 0, 8, 7}, {0, 3, 7, 0, 0, 5, 1, 0, 0}, {9, 0, 0, 0, 4, 2, 0, 0, 0}, {0, 2, 8, 3, 0, 0, 7, 0, 0}, {0, 0, 0, 0, 0, 0, 5, 0, 8}, {0, 5, 0, 0, 2, 0, 9, 6, 0}, {0, 0, 0, 0, 0, 6, 3, 0, 0}};
...
{ // get empty location and update row and column to modify main functions
    for (row = 0; row < N; row++)
        for (col = 0; col < N; col++)
